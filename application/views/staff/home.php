...
<div class="row">
	...
	<div class="col-md-6">
		...
		<button class="btn btn-default">
			<?php echo anchor('staff/update_profile', 'Update Profile'); ?>
		</button>
		
		<button class="btn btn-default">
			<?php echo anchor('staff/reset_password', 'Reset password'); ?>
		</button>
	</div>
</div>
...
<div class="row">
	<div class="col-md-3"></div>
	<div class="col-md-9">
		<h3><?php echo anchor('staff/publication', 'Publications'); ?></h3>
...
<div class="row">
	<div class="col-md-3"></div>
	<div class="col-md-9">
		<h3><?php echo anchor('staff/students', 'Supervised students'); ?></h3>
...
<div class="row">
	<div class="col-md-3"></div>
	<div class="col-md-9">
		<h3><?php echo anchor('staff/research', 'Research projects'); ?></h3>
